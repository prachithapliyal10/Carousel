...
var count=0;
var slidePerPage = slideWidth/3;

//Position of one image horizontally
function positionSlides(slides) {
    for(let index=0; index < slides.length; index++) {
       // slides[index].style.left = slideWidth * index + "px";
       slides[index].style.left =  count + "px";
        count += slidePerPage;
...
nextButton.addEventListener("click", function(){
   ...
   // var currentOne = currentSlide.style.left;
    //var cc = currentOne + slideWidth;
    const nextSlide = currentSlide.nextElementSibling;
    //console.log(currentSlide, nextSlide);
    var position = nextSlide.style.left;
   // position = position * 2;
...
prevButton.addEventListener("click", function(){
    ...
    var position = prevSlide.style.left;
    position = position * 3;
